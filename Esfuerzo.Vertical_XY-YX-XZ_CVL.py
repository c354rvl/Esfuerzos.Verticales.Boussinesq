...
Código generado porla IA Gemini 3 con la formulación de contorno 
planteada por César Vázauez Lorenzana en el curso de Comportamiento de suelo,
y modificado por el autor para las necesidades de análisis y versatilidad.
...
def calcular_sigma_z(x_pts, y_pts, q_pts, x0, y0, z):
    ...
    n = len(x_pts)
    x = np.append(x_pts, x_pts[n-1])
    y = np.append(y_pts, y_pts[n-1])
    total_sum = 0
